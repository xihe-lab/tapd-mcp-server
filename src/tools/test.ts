...
export const testTools: ToolDef[] = [
  ...
  },
  {
    ...
    inputSchema: z.object({
      workspace_id: z.number().optional().describe('项目ID（可省略，使用默认配置）'),
      id: z.string().optional().describe("测试用例ID，支持多ID查询"),
  ...
  },
  {
    ...
    inputSchema: z.object({
      workspace_id: z.number().optional().describe('项目ID（可省略，使用默认配置）'),
      id: z.string().optional().describe("测试用例ID"),
  ...
  },
  {
    ...
    description: "更新测试用例",
    inputSchema: z.object({
      id: z.string().describe("测试用例ID (必填)"),
      workspace_id: z.number().optional().describe('项目ID（可省略，使用默认配置）'),
      name: z.string().optional().describe("测试用例名称"),
      status: z.string().optional().describe("状态"),
      priority: z.string().optional().describe("优先级"),
  ...
  },
  {
    ...
    inputSchema: z.object({
      ...
      parent_id: z.number().optional().describe("父分类ID（用于创建子分类）"),
    }),
    handler: async (client, params) => {
      const workspaceId = params.workspace_id ?? TapdClient.getDefaultWorkspaceId();
      if (!workspaceId) {
  ...
  // 测试用例执行
  {
    ...
    inputSchema: z.object({
      workspace_id: z.number().optional().describe('项目ID（可省略，使用默认配置）'),
      test_plan_id: z.string().describe("测试计划ID (必填)"),
      tcase_id: z.string().describe("测试用例ID (必填)"),
  ...
  },
  {
    ...
    inputSchema: z.object({
      ...
      bug_id: z.string().optional().describe("关联缺陷ID"),
  ...
  },
  {
    ...
    inputSchema: z.object({
      ...
      test_plan_id: z.string().optional().describe("测试计划ID"),
  ...
  // 测试计划 CRUD
  {
    ...
    inputSchema: z.object({
      workspace_id: z.number().optional().describe('项目ID（可省略，使用默认配置）'),
      id: z.string().optional().describe("测试计划ID，支持多ID查询"),
  ...
  },
  {
    ...
    inputSchema: z.object({
      workspace_id: z.number().optional().describe('项目ID（可省略，使用默认配置）'),
      id: z.string().describe("测试计划ID (必填)"),
  ...
  },
  {
    ...
    inputSchema: z.object({
      workspace_id: z.number().optional().describe('项目ID（可省略，使用默认配置）'),
      id: z.string().optional().describe("测试计划ID"),
      name: z.string().optional().describe("测试计划名称"),
      status: z.string().optional().describe("状态"),
      creator: z.string().optional().describe("创建人"),
      owner: z.string().optional().describe("负责人"),
  ...
  },
  {
    ...
    inputSchema: z.object({
      workspace_id: z.number().optional().describe('项目ID（可省略，使用默认配置）'),
      test_plan_id: z.string().describe("测试计划ID (必填)"),
      tcase_id: z.string().describe("测试用例ID (必填)，支持多个ID逗号分隔"),
    }),
    handler: async (client, params) => {
      const workspaceId = params.workspace_id ?? TapdClient.getDefaultWorkspaceId();
      if (!workspaceId) {
