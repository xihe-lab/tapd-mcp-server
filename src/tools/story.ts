...
export const storyTools: ToolDef[] = [
  {
    ...
    inputSchema: z.object({
      ...
      category_id: z.number().optional().describe('Story category, supports enum query'),
      ...
      ancestor_id: z.number().optional().describe('Ancestor story ID, query all child stories'),
  ...
  },
  {
    ...
    inputSchema: z.object({
      ...
      category_id: z.number().optional().describe('Story category'),
      parent_id: z.number().optional().describe('Parent story ID'),
      begin: z.string().optional().describe('Estimated start date, Format: YYYY-MM-DD'),
      due: z.string().optional().describe('Estimated end date, Format: YYYY-MM-DD'),
      effort: z.string().optional().describe('Estimated effort'),
